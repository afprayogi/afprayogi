<picture>
  ...
  <img alt="prayogi — code that ships, circuits that spark" src="assets/banner-dark.svg" width="100%">
</picture>
...
- [omniroute-studio](https://github.com/afprayogi/omniroute-studio) — Klien chat mandiri (1 file HTML) untuk OmniRoute — chat biasa, grup multi-model, dan mode diskusi meja-bundar dengan moderator & notulen otomatis, terinspirasi Claude & ChatGPT.  Single-file HTML chat client for OmniRoute — 1:1 chat, multi-model group chat, and AI roundtable discussions with auto moderator, note-taker & consensus summary.  · `html`
- [ppe_apk_prototype](https://github.com/afprayogi/ppe_apk_prototype) · `dart`
<!--END_PROJECTS-->
...
<!--LAST_UPDATED-->
`last sync: 2026-09-03 19:33 UTC` — kept honest by [update.py](update.py), not by hand
<!--END_LAST_UPDATED-->
